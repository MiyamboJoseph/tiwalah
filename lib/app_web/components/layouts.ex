defmodule AppWeb.Layouts do
  ...
  def app(assigns) do
    ...
    <header class="border-b border-emerald-950/10 bg-[#fcfaf3] px-4 py-4 dark:bg-base-100 sm:px-8">
      <div class="mx-auto flex max-w-7xl items-center justify-between gap-4">
        <a
          ...
          class="flex items-center gap-3 text-emerald-950 dark:text-emerald-100"
        >
        ...
        <nav class="flex items-center gap-2">
          ...
          <%= if @current_scope && @current_scope.user do %>
            ...
            <.link
              ...
              method="delete"
              class="rounded-lg bg-emerald-800 px-3 py-2 text-sm font-semibold text-white"
            >
              Sign out
            </.link>
          <% else %>
            <.link navigate={~p"/users/log-in"} class="text-sm font-semibold text-emerald-800">
              Sign in
            </.link>
            <.link
    ...
    <main class="min-h-[calc(100vh-73px)] bg-[#f8f6ee] px-4 py-10 dark:bg-base-100 sm:px-6 lg:px-8">
