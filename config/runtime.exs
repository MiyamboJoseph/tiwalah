...
if config_env() == :prod do
  ...
  smtp_password =
    System.get_env("SMTP_PASSWORD") ||
      raise "environment variable SMTP_PASSWORD is required to send Tilawah emails"

  smtp_username =
    System.get_env("SMTP_USERNAME") || raise "environment variable SMTP_USERNAME is required"
