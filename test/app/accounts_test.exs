defmodule App.AccountsTest do
  ...
  describe "register_user/1" do
    ...
    test "registers a tutor with the selected role" do
      {:ok, user} = Accounts.register_user(valid_user_attributes(role: :tutor))

      assert user.role == :tutor
    end

    test "rejects an unknown registration role" do
      {:error, changeset} = Accounts.register_user(valid_user_attributes(role: "administrator"))
